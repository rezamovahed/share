          ...
          <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            >
              <button
                ...
                @click.prevent="hideEditIntegrationTokenModal"
                @keydown.esc="hideEditIntegrationTokenModal"
              >
                Cancel
              </button>
            </span>
...
export default {
  ...
  computed: {
    token() {
      return this.$store.state.account.editIntegrationTokenModalData
    },
  },
  mounted() {
    ...
    const close = (e) => {
      ...
      this.hideEditIntegrationTokenModal()
    }
  ...
  methods: {
    async toggleEditIntegrationTokenModal() {
      await this.$store.dispatch(
        'account/TOGGLE_SHOW_EDIT_INTERGRATION_TOKEN_MODAL'
      )
    },
    async hideEditIntegrationTokenModal() {
